...
> 🎉 Customized by Sheldon with a few extras as my default dev environment with a special focus on Go and PowerShell support.

### Extras

- Install Starship for command prompt.
- Install Mage/Mage-Select for task running.
